...
class RunboHost(models.Model):
    ...
    enable_default_crons = fields.Boolean(default=True)
    enable_create_build_cron = fields.Boolean(default=False)
    enable_run_build_cron = fields.Boolean(default=False)
