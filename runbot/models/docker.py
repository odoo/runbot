...
class Dockerfile(models.Model):
    ...
    auto_sync = fields.Boolean('Auto sync', help='Automatically sync the identifier with the future identifier', default=lambda self: not self.env['ir.config_parameter'].sudo().get_bool('runbot.runbot_dockerfile_disable_auto_sync_by_default', False), tracking=True)
